...
class AuthProviderMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:auth-provider';
     ...
     * @var string
     */
    protected $description = 'Create a new auth service provider for the specified module.';
