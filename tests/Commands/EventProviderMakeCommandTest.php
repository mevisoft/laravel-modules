...
class EventProviderMakeCommandTest extends BaseTestCase
{
    ...
    {
        $this->artisan('module:event-provider', ['module' => 'Blog']);
    ...
    public function it_can_change_the_default_namespace()
    {
        ...
        $file = $this->finder->get($this->modulePath . '/SuperProviders/EventServiceProvider.php');
    ...
    /** @test */
    public function it_can_overwrite_event_file_names()
    {
        $this->app['config']->set('modules.stubs.files.events/web', 'SuperEvents/web.php');
        $this->app['config']->set('modules.stubs.files.events/api', 'SuperEvents/api.php');

        $this->artisan('module:event-provider', ['module' => 'Blog', '--force' => true]);
    ...
    public function it_can_change_the_custom_controller_namespace(): void
    {
        ...
        $this->artisan('module:event-provider', ['module' => 'Blog']);
        $file = $this->finder->get($this->modulePath . '/Base/Providers/EventServiceProvider.php');
